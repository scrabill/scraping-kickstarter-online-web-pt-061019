...
def create_project_hash
  ...
  kickstarter.css("li.project.grid_4").each do |project|
    ...
    projects[title.to_sym] = {
      :description => project.css("li.project.grid_4 p.bbcard_blurb").text.strip,
      :image_link => project.css("li.project.grid_4 img.projectphoto-little").attribute("src").value,
      :location => project.css("li.project.grid_4 span.location-name").text.strip,
      :percent_funded => project.css("li.project.grid_4 li.first strong").text.strip
    }
  end
